...
11. [Jenkins Plugins](https://github.com/jadedjelly/nana-techworld-devops-bootcamp/blob/main/notes/08_jenkins.md#Jenkins-Plugins)
    a. [Demo: Static Code Analysis Results](https://github.com/jadedjelly/nana-techworld-devops-bootcamp/blob/main/notes/08_jenkins.md#Demo:-Static-Code-Analysis-Results)
    b. [Demo: Static Code Analysis Results](https://github.com/jadedjelly/nana-techworld-devops-bootcamp/blob/main/notes/08_jenkins.md#Demo:-Static-Code-Analysis-Results)
12. [Advanced CI/CD Jenkins Pipelines](https://github.com/jadedjelly/nana-techworld-devops-bootcamp/blob/main/notes/08_jenkins.md#Advanced-CI/CD-Jenkins-Pipelines)
    a. [Jenkins Credentials & Security (VIP)](https://github.com/jadedjelly/nana-techworld-devops-bootcamp/blob/main/notes/08_jenkins.md#Jenkins-Credentials-&-Security-(VIP))
    b. [Spring boot & Jenkins](https://github.com/jadedjelly/nana-techworld-devops-bootcamp/blob/main/notes/08_jenkins.md#Spring-boot-&-Jenkins)
    c. [Jenkins, Docker, Maven & Github](https://github.com/jadedjelly/nana-techworld-devops-bootcamp/blob/main/notes/08_jenkins.md#Jenkins,-Docker,-Maven-&-Github)
---------------------------------------------------------------------------------------------------------------------
